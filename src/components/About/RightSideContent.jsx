      ...
      <div className="sticky top-24">
        <div className="mb-10">
          ...
          >
            ...
            >
              ...
              <li>
                <Highlight>MERN Stack, MongoDB, Node.js</Highlight>:
        ...
        <div className="mt-8">
          ...
          <div className="flex flex-wrap gap-2">
            {["Frontend Specialization", "Modern Web Development","Advanced React Patterns", "Testing with Jest & React Testing Library",].map((item, i) => (
              <span
                key={i}
