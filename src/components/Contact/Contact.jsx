          ...
          <motion.div className="space-y-10" variants={containerVariants}>
            {[
              {
                icon: "Mail",
                title: "Email",
                value: "2012prabhat@gmail.com",
                href: "mailto:2012prabhat@gmail.com",
              },
              {
                icon: "Phone",
                title: "Phone",
                value: "+91-9711393310",
                href: "tel:+919711393310",
              },
              {
                icon: "MapPin",
                title: "Location",
            ...
            >
              <div className="absolute inset-0 flex items-center justify-center">
                <iframe
                  src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Shahdara%20Delhi+(Prabhat%20Kumar)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
